...
local JM_PrintName              = JM_Global_Buff_KarmaBuff_Extra_Credit_Name
local JM_BuffNWBool             = JM_Global_Buff_KarmaBuff_Extra_Credit_NWBool
local JM_BuffDuration           = JM_Global_Buff_KarmaBuff_Extra_Credit_Duration
local JM_BuffIconName           = JM_Global_Buff_KarmaBuff_Extra_Credit_IconName
local JM_BuffIconPath           = JM_Global_Buff_KarmaBuff_Extra_Credit_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_KarmaBuff_Extra_Credit_IconGoodBad
