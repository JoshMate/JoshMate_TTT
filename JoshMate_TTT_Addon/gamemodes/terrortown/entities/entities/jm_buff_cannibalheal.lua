...
local JM_PrintName              = JM_Global_Buff_CannibalHeal_Name
local JM_BuffNWBool             = JM_Global_Buff_CannibalHeal_NWBool
local JM_BuffDuration           = JM_Global_Buff_CannibalHeal_Duration
local JM_BuffIconName           = JM_Global_Buff_CannibalHeal_IconName
local JM_BuffIconPath           = JM_Global_Buff_CannibalHeal_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_CannibalHeal_IconGoodBad
