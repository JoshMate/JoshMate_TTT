...
local JM_PrintName              = JM_Global_Buff_HealthGrenade_Name
local JM_BuffNWBool             = JM_Global_Buff_HealthGrenade_NWBool
local JM_BuffDuration           = JM_Global_Buff_HealthGrenade_Duration
local JM_BuffIconName           = JM_Global_Buff_HealthGrenade_IconName
local JM_BuffIconPath           = JM_Global_Buff_HealthGrenade_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_HealthGrenade_IconGoodBad
