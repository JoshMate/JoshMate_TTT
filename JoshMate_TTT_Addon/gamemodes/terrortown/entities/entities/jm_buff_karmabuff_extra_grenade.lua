...
local JM_PrintName              = JM_Global_Buff_KarmaBuff_Extra_Grenade_Name
local JM_BuffNWBool             = JM_Global_Buff_KarmaBuff_Extra_Grenade_NWBool
local JM_BuffDuration           = JM_Global_Buff_KarmaBuff_Extra_Grenade_Duration
local JM_BuffIconName           = JM_Global_Buff_KarmaBuff_Extra_Grenade_IconName
local JM_BuffIconPath           = JM_Global_Buff_KarmaBuff_Extra_Grenade_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_KarmaBuff_Extra_Grenade_IconGoodBad
