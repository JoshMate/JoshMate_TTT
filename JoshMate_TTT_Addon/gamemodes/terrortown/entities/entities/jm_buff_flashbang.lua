...
local JM_PrintName              = JM_Global_Buff_StunGrenade_Name
local JM_BuffNWBool             = JM_Global_Buff_StunGrenade_NWBool
local JM_BuffDuration           = JM_Global_Buff_StunGrenade_Duration
local JM_BuffIconName           = JM_Global_Buff_StunGrenade_IconName
local JM_BuffIconPath           = JM_Global_Buff_StunGrenade_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_StunGrenade_IconGoodBad
