...
local JM_PrintName              = JM_Global_Buff_MotionSensorTrack_Name
local JM_BuffNWBool             = JM_Global_Buff_MotionSensorTrack_NWBool
local JM_BuffDuration           = JM_Global_Buff_MotionSensorTrack_Duration
local JM_BuffIconName           = JM_Global_Buff_MotionSensorTrack_IconName
local JM_BuffIconPath           = JM_Global_Buff_MotionSensorTrack_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_MotionSensorTrack_IconGoodBad
...
-- ESP Halo effect
hook.Add( "PreDrawHalos", "Halos_MotionSensor", function()
