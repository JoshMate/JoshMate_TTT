...
local JM_PrintName              = JM_Global_Buff_Taser_Name
local JM_BuffNWBool             = JM_Global_Buff_Taser_NWBool
local JM_BuffDuration           = JM_Global_Buff_Taser_Duration
local JM_BuffIconName           = JM_Global_Buff_Taser_IconName
local JM_BuffIconPath           = JM_Global_Buff_Taser_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_Taser_IconGoodBad
