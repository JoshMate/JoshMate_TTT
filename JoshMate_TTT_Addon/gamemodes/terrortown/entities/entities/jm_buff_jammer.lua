...
local JM_PrintName              = JM_Global_Buff_Jammer_Name
local JM_BuffNWBool             = JM_Global_Buff_Jammer_NWBool
local JM_BuffDuration           = JM_Global_Buff_Jammer_Duration
local JM_BuffIconName           = JM_Global_Buff_Jammer_IconName
local JM_BuffIconPath           = JM_Global_Buff_Jammer_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_Jammer_IconGoodBad
