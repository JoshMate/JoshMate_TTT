...
local JM_PrintName              = JM_Global_Buff_Dna_Name
local JM_BuffNWBool             = JM_Global_Buff_Dna_NWBool
local JM_BuffDuration           = JM_Global_Buff_Dna_Duration
local JM_BuffIconName           = JM_Global_Buff_Dna_IconName
local JM_BuffIconPath           = JM_Global_Buff_Dna_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_Dna_IconGoodBad
