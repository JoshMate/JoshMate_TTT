...
local JM_PrintName              = JM_Global_Buff_MoneyPrinter_Name
local JM_BuffNWBool             = JM_Global_Buff_MoneyPrinter_NWBool
local JM_BuffDuration           = JM_Global_Buff_MoneyPrinter_Duration
local JM_BuffIconName           = JM_Global_Buff_MoneyPrinter_IconName
local JM_BuffIconPath           = JM_Global_Buff_MoneyPrinter_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_MoneyPrinter_IconGoodBad
...
-- This buff is managed in the tree of life ent file, so only uses this file to init it's values
