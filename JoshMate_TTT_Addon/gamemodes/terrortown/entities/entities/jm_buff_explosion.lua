...
local JM_PrintName              = JM_Global_Buff_Explosion_Name
local JM_BuffNWBool             = JM_Global_Buff_Explosion_NWBool
local JM_BuffDuration           = JM_Global_Buff_Explosion_Duration
local JM_BuffIconName           = JM_Global_Buff_Explosion_IconName
local JM_BuffIconPath           = JM_Global_Buff_Explosion_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_Explosion_IconGoodBad
