...
JM_KARMA_REWARD_ACTION_BEARTRAP                 = 4
JM_KARMA_REWARD_ACTION_TRAPREMOVED              = 2
JM_KARMA_REWARD_ACTION_DNASCAN                  = 2
JM_KARMA_REWARD_ACTION_TREEHEAL                 = 2
JM_KARMA_REWARD_ACTION_BURGERHEAL               = 2
JM_KARMA_REWARD_ACTION_HEALTHGRENADEHEAL        = 2
JM_KARMA_REWARD_ACTION_ENERGYDRINKHEAL          = 4
JM_KARMA_REWARD_ACTION_VISUALISER               = 4
JM_KARMA_REWARD_ACTION_AGENT                    = 2
JM_KARMA_REWARD_ACTION_OBJECTIVE_Bomb           = 4
