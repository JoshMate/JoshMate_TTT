...
local JM_PrintName              = JM_Global_Buff_BarrierSlow_Name
local JM_BuffNWBool             = JM_Global_Buff_BarrierSlow_NWBool
local JM_BuffDuration           = JM_Global_Buff_BarrierSlow_Duration
local JM_BuffIconName           = JM_Global_Buff_BarrierSlow_IconName
local JM_BuffIconPath           = JM_Global_Buff_BarrierSlow_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_BarrierSlow_IconGoodBad
