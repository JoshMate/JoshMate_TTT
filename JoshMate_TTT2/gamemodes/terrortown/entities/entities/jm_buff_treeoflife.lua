...
local JM_PrintName              = JM_Global_Buff_TreeOfLife_Name
local JM_BuffNWBool             = JM_Global_Buff_TreeOfLife_NWBool
local JM_BuffDuration           = JM_Global_Buff_TreeOfLife_Duration
local JM_BuffIconName           = JM_Global_Buff_TreeOfLife_IconName
local JM_BuffIconPath           = JM_Global_Buff_TreeOfLife_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_TreeOfLife_IconGoodBad
