...
local JM_PrintName              = JM_Global_Buff_SilencedPistol_Name
local JM_BuffNWBool             = JM_Global_Buff_SilencedPistol_NWBool
local JM_BuffDuration           = JM_Global_Buff_SilencedPistol_Duration
local JM_BuffIconName           = JM_Global_Buff_SilencedPistol_IconName
local JM_BuffIconPath           = JM_Global_Buff_SilencedPistol_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_SilencedPistol_IconGoodBad
