...
local JM_PrintName              = JM_Global_Buff_SuddenDeath_Name
local JM_BuffNWBool             = JM_Global_Buff_SuddenDeath_NWBool
local JM_BuffDuration           = JM_Global_Buff_SuddenDeath_Duration
local JM_BuffIconName           = JM_Global_Buff_SuddenDeath_IconName
local JM_BuffIconPath           = JM_Global_Buff_SuddenDeath_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_SuddenDeath_IconGoodBad
