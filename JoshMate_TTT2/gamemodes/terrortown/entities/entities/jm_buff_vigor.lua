...
local JM_PrintName              = JM_Global_Buff_Vigor_Name
local JM_BuffNWBool             = JM_Global_Buff_Vigor_NWBool
local JM_BuffDuration           = JM_Global_Buff_Vigor_Duration
local JM_BuffIconName           = JM_Global_Buff_Vigor_IconName
local JM_BuffIconPath           = JM_Global_Buff_Vigor_IconPath
local JM_BuffIconGoodBad        = JM_Global_Buff_Vigor_IconGoodBad
