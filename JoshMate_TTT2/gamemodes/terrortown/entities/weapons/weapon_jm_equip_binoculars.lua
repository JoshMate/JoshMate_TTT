...
if CLIENT then
	...
	function SWEP:Initialize()
		self:AddTTT2HUDHelp("Scan a body", "Change zoom level")
	...
	hook.Add("TTTRenderEntityInfo", "HUDDrawTargetIDBinocular", function(tData)
		...
		if not IsValid(ent) or ent:GetClass() ~= "prop_ragdoll" or c_wep:GetClass() ~= "weapon_jm_equip_binoculars" then return end
