...
INNO_EQUIPMENT = {
	...
	"weapon_jm_equip_doom_dart",
	"weapon_jm_equip_poisondart",
	"weapon_jm_equip_placer_barrel",
	"weapon_jm_equip_moneyprinter",
	"weapon_jm_equip_silencedpistol",
	"weapon_jm_equip_supercrowbar",
	...
	"weapon_jm_equip_binoculars",
	"weapon_jm_equip_c4",
	"weapon_jm_equip_knife",
	"weapon_jm_equip_newtonlauncher",
	"weapon_jm_equip_radio",
	"weapon_jm_equip_teleporter",
